...
# Parametreler
# ==============================
FILE_NAME = r"C:\Users\EXCALIBUR\Desktop\sahibinden\megane_xlxs\megane_11eylül.xlsx"
OUT_DIR   = Path(r"C:\Users\EXCALIBUR\Desktop\sahibinden\megane_model_tahmin\catboster")
...
def avg_same_clean(df_ref, row, col_model, col_year, col_km, part_cols_map, km_window=30_000, min_n=3):
    ...
    for pat, col in part_cols_map.items():
...
def main():
    ...
    # Filtre: yıl >= 2015, mantıklı sınırlar
    mask = (
        (df["_year"] >= 2015) &
